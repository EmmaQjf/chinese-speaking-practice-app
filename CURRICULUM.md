...
Start with **Phase 2.9** (`assertClassAccess` + enforce on class-scoped APIs). Build in order; each step reuses patterns from Phase 1 (Mongoose model, Zod, `fetch`, session).
